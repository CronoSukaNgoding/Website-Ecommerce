        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="<?= base_url("tambah-produk") ?>">
                    <button class="btn btn-primary btn-bg-gradient-x-blue-green box-shadow-2" value="" title="Update Produk" style="margin-bottom: 10px;">
                        <i class="fas fa-pencil-alt"></i> Tambah Produk
                    </button>
                </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url("edit-produk/" . $value->produk) ?>">
                                            <button class="btn btn-success btn-sm btn-bg-gradient-x-blue-green box-shadow-2" value="" title="Update Produk">
                                                <i class="fas fa-pencil-alt"></i>
                                            </button>
                                        </a>
                                        <button class="btn btn-danger btn-sm btn-bg-gradient-x-blue-green box-shadow-2 mt-1" type="button" value="" title="Hapus Produk" data-bs-toggle="modal" data-bs-target="#hapus<?= $value->produk; ?>">
