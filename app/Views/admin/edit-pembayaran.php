    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?=base_url("pembayaran/edit/").$result->idPayment?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" class="form-control select2" id="statusSelect">
